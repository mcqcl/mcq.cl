(() => {
  ...
  function resolveHero(data){
    ...
    return base ? (base.replace(/\/+$/,'') + "/" + hero.replace(/^\/+/,'')) : hero;
  }
            ...
            <div class="pad">
              <div class="side-stack">
                <div class="panel">
                  ...
                  <div class="kv">
                    <div class="kv-row"><span>Autor</span><strong id="author">—</strong></div>
                    <div class="kv-row"><span>Publicado</span><strong id="published">—</strong></div>
                  </div>
                </div>
  ...
  function render(data){
    ...
    // Body: si existe template, gana
    const tpl = document.getElementById('pageBody');
    const bodyHtml = tpl ? tpl.innerHTML : (data.bodyHtml || '<p>—</p>');
    $id('content').innerHTML = bodyHtml;
